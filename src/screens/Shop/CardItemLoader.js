...
const LoaderPrice = () => (
  <ContentLoader
    ...
    height={45}
    viewBox="0 0 70 45"
    backgroundColor="#ac54f1"
    foregroundColor="#ffffff">
    <Rect x="-1" y="-1" rx="0" ry="0" width="70" height="45" />
  </ContentLoader>
);
const LoaderText = () => (
  <ContentLoader
    ...
    foregroundColor="#ffffff">
    <Rect x="5" y="-5" rx="0" ry="0" width="55" height="84" />
  </ContentLoader>
);
const LoaderImage = () => (
  <ContentLoader
    ...
    foregroundColor="#ffffff">
    <Rect x="0" y="0" rx="0" ry="0" width="200" height="162" />
  </ContentLoader>
);
...
const CardItemLoader = () => {
  return (
    <TouchableOpacity style={s.item}>
      {/* <View style={s.image}><SvgXml xml={icons.placeholder} /></View> */}
      <LoaderImage />
      <View style={s.info}>
